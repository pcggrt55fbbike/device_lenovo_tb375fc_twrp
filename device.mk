...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/root/system/etc/fstab.mt6897:$(TARGET_COPY_OUT_RECOVERY)/root/system/etc/fstab.mt6897 \
    $(LOCAL_PATH)/recovery/root/system/etc/init/init.recovery.mt6897.rc:$(TARGET_COPY_OUT_RECOVERY)/root/system/etc/init/init.recovery.mt6897.rc \
